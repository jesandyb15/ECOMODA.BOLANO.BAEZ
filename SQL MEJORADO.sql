...
foreign key fk_documento_referencia_cobrar (documento_referencia) references orden_venta(id_orden_venta),
foreign key fk_valor_cobrar (valor) references orden_venta(precio)
);
...
foreign key fk_documento_referencia (documento_referencia) references orden_compra(id_orden_compra),
foreign key fk_valor (valor) references orden_compra(precio)
);
